...
void PasswordsWindow::on_aboutButton_clicked()
{
    QMessageBox::information(
                ...
                "В левой части окна находятся группы с паролями.<br> \
                 Чтобы удалить группу, кликните на неё и нажмите Ctrl-D.<br>  \
                 Также возможно заблокировать изменение группы, для этого нажмите Ctrl-E. Для разблокировки снова нажмите Ctrl-E.<br> \
                 Не создавайте группы с одинаковыми названиями или данные будут утеряны.<br>\
                 Сохраняйте файл с расширением .dpm\
                "
    );
}
